...
- **Se quita la nota repetitiva de "¿Cuánto cuesta?"** ("Cada diligencia es distinta, así que te doy el valor exacto por WhatsApp antes de empezar, sin sorpresas ni cobros de más"), que decía prácticamente lo mismo que el párrafo justo encima. Queda el subtítulo y el botón de WhatsApp.
- **Se quita el rayo del icono de "Respuesta rápida por WhatsApp"**, a petición del cliente. La burbuja de chat se queda, ahora con tres puntos dentro (el símbolo habitual de "escribiendo/respondiendo"), que sigue leyéndose como respuesta rápida sin el rayo.
